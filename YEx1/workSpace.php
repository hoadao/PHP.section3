<?php
$customer_list = array(
    "1" => array("name" => "First Daughter", "day_of_birth" => "1983/08/20", "address" => "Hà Nội", "profile" => "first_daughter.png"),
    "2" =>array("name" => "Second daughter", "day_of_birth" => "1983/08/21", "address" => "Bắc Giang", "profile" => "second_daughter.png"),
    "3" =>array("name" => "Third Daughter", "day_of_birth" => "1983/08/22", "address" => "Nam Định", "profile" => "third_daughter.png"),
    "4" =>array("name" => "Forth Daughter", "day_of_birth" => "1983/08/17", "address" => "Hà Tây", "profile" => "fourth_daughter.png"),
